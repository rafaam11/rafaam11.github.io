...
Jinmin Kim의 3D 정합·공간 시스템 포트폴리오입니다. 빌드 과정이 없는 정적 HTML/CSS/JavaScript 사이트이며 GitHub Pages가 `main` 브랜치의 루트를 직접 서비스합니다.
...
- 공개 승인이 없는 고객사·병원·기관명과 원본 경로를 노출하지 않습니다.
